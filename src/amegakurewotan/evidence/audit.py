...
logger = logging.getLogger("amegakurewotan.evidence.audit")
...
class ForensicAuditLedger:
    ...
    def _check_key_rotation(self):
        ...
        KEY_ROTATION_DAYS = int(os.environ.get("AMEWOTAN_KEY_ROTATION_DAYS", "30"))
    ...
    def log_execution(
        ...
        run_id_val = run_id or parameters.get("run_id") or os.environ.get("AMEWOTAN_RUN_ID") or str(uuid.uuid4())
        schema_version_val = schema_version or os.environ.get("AMEWOTAN_SCHEMA_VERSION") or "9.4"
        operator_id_val = operator_id or os.environ.get("AMEWOTAN_OPERATOR_ID") or "operator-default"
        target_id_val = target_id or parameters.get("target") or parameters.get("target_id") or os.environ.get("AMEWOTAN_TARGET_ID") or "target-default"
        ...
        hypothesis_id_val = hypothesis_id or os.environ.get("AMEWOTAN_HYPOTHESIS_ID") or f"hyp-{run_id_val}"
        phase_id_val = phase_id or os.environ.get("AMEWOTAN_PHASE_ID") or action or "phase-default"
