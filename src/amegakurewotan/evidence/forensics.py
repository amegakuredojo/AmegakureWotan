...
"""
Módulo: amegakurewotan.evidence.forensics
Contexto: CIVIL — Consolidación AmegakureWotan (AmegakureWotan + SENTINEL-OSINT)
...
Propósito:
    ...
    El "Forensic Audit Ledger" de AmegakureWotan (evidence/audit.py) se conserva como
...
logger = logging.getLogger("amegakurewotan.evidence.forensics")
