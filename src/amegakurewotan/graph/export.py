...
def export_to_json(
    ...
    run_id_val = run_id or os.environ.get("AMEWOTAN_RUN_ID") or str(uuid.uuid4())
    operator_id_val = operator_id or os.environ.get("AMEWOTAN_OPERATOR_ID") or "operator-default"
    target_id_val = target_id or os.environ.get("AMEWOTAN_TARGET_ID") or "target-default"
    ...
    hypothesis_id_val = hypothesis_id or os.environ.get("AMEWOTAN_HYPOTHESIS_ID") or f"hyp-{uuid.uuid4()}"
    phase_id_val = phase_id or os.environ.get("AMEWOTAN_PHASE_ID") or "export"
