...
"""
Módulo: amegakurewotan.dfir.velociraptor
...
from amegakurewotan.dfir.runner import tool_unavailable_result

logger = logging.getLogger("amegakurewotan.dfir.velociraptor")
