...
from amegakurewotan.agents.normalizer import EntitySeedNormalizer, SeedExpander
from amegakurewotan.graph.provenance import ProvenanceRouter
import uuid

logger = logging.getLogger("amegakurewotan.agents.huginn")
    ...
    def execute(self, target: str, entity_type: str = "Persona física", **kwargs) -> Dict[str, Any]:
        ...
        def analyze_entity():
            ...
            prov_payload = {
                ...
                "source_uri": "amegakurewotan://agents/huginn/execute",
                "agent_name": "huginn",
                "tool_version": "2.1",
                "entity_type": final_type,
