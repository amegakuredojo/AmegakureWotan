...
from karasugakure.policy.opsec import check_tor_socks_proxy, get_active_proxies
...
class KarasuTuiApp(App):
    """The main Karasugakure Terminal User Interface App."""
    ...
    def on_mount(self) -> None:
        self.title = "KARASUGAKURE OSINT CONTROL PANEL"
        self.sub_title = "Tactical Intelligence & Forensic Graph Harness"
        
        log_widget = self.query_one("#console-logs", LogStreamer)
        log_widget.write("[bold green][SYSTEM] Karasugakure TUI successfully initialized.[/bold green]")
