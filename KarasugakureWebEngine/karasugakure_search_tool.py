...
Consume el endpoint JSON local (127.0.0.1:8080) — no hace scraping directo
...
# --- LangChain Tool wrapper (opcional, requiere `pip install langchain pydantic`) --
try:
    ...
    SearxNGSearchTool = None  # LangChain no instalado — el CLI sigue funcionando solo
